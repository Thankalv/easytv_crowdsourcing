module.exports = {
    ...
    friendlyName: 'A user can now access/work with Archive content',
    ...
    inputs:{
        ...
        user: {
            type: 'string',
            description: 'The id of the user to allow'
        },
        lang: {
    ...
    fn: async function (inputs, exits) 
    {
        ...
        user2allow.lang_info = await VoluntService.toArchive(user2allow, inputs.lang);
        ...
        await ENService.sendEN(updUser, 7, inputs.lang);
