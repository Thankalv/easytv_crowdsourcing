module.exports = {
    ...
    description: "An Evaluator of a certain job can review the confidence of previous 'Reviewer' users of this same job",
    inputs: {
        job_id: {
    ...
    fn: async function (inputs) 
    {
      ...
      // ONLY an 'EVALUATOR' that's currently working on this job_id is able to modify the contibuting users' confidence
      var prevUsersList = [];
      var prevUsers = [];
