...
function swalModal(modaltype) {
    if(modaltype=="error")
        ...
        Swal.fire({
            ...
            type: 'success',
            title: 'Done!',
            text: 'Thanks for your judgement!',
        });
}
...
window.onload = function(){ setTimeout(function() { vacRemove(); },500); }
...
// execute Service-4 of the Ontology-API
$("#post-validation").on("click", function() 
{
    // get the bar's score
    console.log(vid1);
    console.log(vid2);
